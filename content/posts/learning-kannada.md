...
Kannada shares many similarities with Hindi in grammar and script.
...
Kannada and Devanagari mostly have the same characters,
...
Addings nouns to your vocabulary is easy.
...
Here we used the verbs 'keep', 'put', 'put' in the English sentences,
and we used the verbs 'रखो (rakho)', 'रखो (rakho)', 'डालो (daalo)' in Hindi.
As you can see, the English and Hindi words don't cleanly map to each other.
The English translation of 'डालो (daalo)' is 'put', but 'डालो (daalo)' refers
specifically to the act of putting someting inside something else.
